        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mb-4 mb-lg-0" style="margin-left: auto;">
            <div class="col-mx-3" v-if="this.$store.state.isAuthenticated === true">
              <button class="container btn btn-outline-success dropdown-toggle" type="button" data-bs-toggle="dropdown"
                aria-expanded="false">
                {{ this.username }}
              </button>
              <li class="container nav-item dropdown dropdown-menu-left">
                <ul class="dropdown-menu dropdown-menu-start dropdown-menu-lg-end"
                  ...
                  <div class="row">
                    <li>
                      <button class="container-fluid btn btn-success disabled">
                        Logged In
                      </button>
                    </li>
                  </div>
            ...
            <div class="col-mx-4" v-else>
              <button class="container btn btn-outline-danger dropdown-toggle" type="button" data-bs-toggle="dropdown"
                aria-expanded="false">
                Not Logged In
              </button>
              <li class="container nav-item dropdown ">
                <ul class="dropdown-menu dropdown-menu-left col-mx-3"
                  style="background: transparent; padding-right: 10px;">
                  <router-link to="/login">
                    <li>
                      <button class="container-fluid btn btn-outline-primary">
                        Login
                      </button>
                    </li>
                  </router-link>
