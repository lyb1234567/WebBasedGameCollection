  ...
  <div class="box">
    ...
    <div class="right-box">
        ...
        <div class="info-box">
          ...
          <div class="news">
            ...
            <div class="dailog-box">
              ...
              <div class="item-box1">
                <div class="item-left" @click="$router.push('/introducepage')">
              ...
              <div class="item-box2" @click="$router.push('/introducepage')">
                <div class="item2-top">
                  <div class="txt-tit">
                    <h1>Martin Goutry</h1>
              ...
              <div class="item-box3" @click="$router.push('/introducepage')">
      ...
      <div class="right-con">
        ...
        <div class="box-tit">Trending Collections</div>
