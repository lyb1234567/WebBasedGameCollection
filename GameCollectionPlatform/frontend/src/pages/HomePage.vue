<template>
  <div class="box">
    ...
    <div class="right-box">
      ...
      <div class="right-con">
        <div class="box-tit">Trending Games</div>
        <div class="con-item-box">
          <div class="con-item" v-for=" game in games" v-bind:key="game" >
            <div class="con-img">              
              <img v-bind:src="game.gameicon" alt="" @click="this.checkLoginAndRedirect(game)">
            </div>
            <div class="sub">Board Game</div>
...
export default {
  ...
  methods: {
    ...
    async fetchGames() {
      axios.defaults.headers.common['Authorization'] = "";
      await axios.get('api/v1/game/')
        .then(response => {
          console.log(response.data[0]['gameicon'])
