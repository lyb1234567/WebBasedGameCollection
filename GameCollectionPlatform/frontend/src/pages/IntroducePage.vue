    ...
    <div class="left-box">
      ...
      <ul class="left-nav">
        ...
        <li>
          ...
          >
            <path
              d="M18 14.4167H13.25M18 9.66667V14.4167V9.66667ZM18 14.4167V19.1667V14.4167ZM18 14.4167H22.75H18Z"
              stroke="white"
    ...
    <div class="right-box">
      <div class="right-top">
        ...
        <div class="info-box">
          <div class="notice">
            ...
            <div class="dailog-box">
              ...
              <di class="item">
                ...
                <div class="item-p">
                  <p>$39.99</p>
                  <div class="item-sub">Brand new</div>
                </div>
                <div class="icon"></div>
              </di>
              <di class="item">
          ...
          <!-- <div class="news"></div> -->
          <div class="info-pic" @click="$router.push('/infopage')">
            <img src="../assets/images/pic.png" alt="" />
          </div>
        </div>
      </div>
      <div class="right-con">
        <div class="con-top"><img src="../assets/images/m4.png" alt="" /></div>
        <div class="con-txt">
          <div class="box-tit">Description</div>
          <div class="box-sub-tit">
            Strategically grow your ecosystem card engine with unique flora, fauna, and terrains.
          </div>
          <ul class="con-ul">
            <li>435 Ratings & 322 Comments</li>
            <li>Gameplay: 1–5 Players</li>
            <li>Playing Time : 45–90 Min</li>
            <li>Age: 13+</li>
            <li>Community: 10+</li>
            <li>Weight: 2.80 / 5</li>
            <li>Complexity Rating</li>
            <li>publisher: Maxime Tardif</li>
          </ul>
          <div class="icon-box">
            <div class="icon1">
              <svg
              ...
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M16.9172 4.08304C15.2511 2.41697 12.4574 2.41697 10.7913 4.08304L9.26106 5.61329C8.88681 5.98754 8.28002 5.98754 7.90577 5.61329C7.53152 5.23903 7.53152 4.63225 7.90577 4.258L9.43601 2.72776C11.8506 0.313181 15.8579 0.313181 18.2725 2.72776C20.6871 5.14233 20.6871 9.14965 18.2725 11.5642L16.7422 13.0945C16.368 13.4687 15.7612 13.4687 15.387 13.0945C15.0127 12.7202 15.0127 12.1134 15.387 11.7392L16.9172 10.2089C18.5833 8.54287 18.5833 5.74911 16.9172 4.08304ZM14.0527 6.94751C14.427 7.32177 14.427 7.92855 14.0527 8.3028L8.30272 14.0528C7.92847 14.4271 7.32169 14.4271 6.94744 14.0528C6.57318 13.6785 6.57318 13.0718 6.94744 12.6975L12.6974 6.94751C13.0717 6.57326 13.6785 6.57326 14.0527 6.94751ZM5.61321 7.90585C5.98746 8.2801 5.98746 8.88688 5.61321 9.26114L4.08297 10.7914C2.4169 12.4574 2.4169 15.2512 4.08297 16.9173C5.74904 18.5833 8.54279 18.5833 10.2089 16.9173L11.7391 15.387C12.1134 15.0128 12.7201 15.0128 13.0944 15.387C13.4686 15.7613 13.4686 16.3681 13.0944 16.7423L11.5642 18.2726C9.14958 20.6871 5.14225 20.6871 2.72768 18.2726C0.313104 15.858 0.313104 11.8507 2.72768 9.43609L4.25792 7.90585C4.63217 7.53159 5.23896 7.53159 5.61321 7.90585Z"
                  fill="white"
                />
              </svg>
            </div>
            <div class="icon2">
              ...
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M2.75004 4.50347V19.3705C2.75004 20.0478 3.52137 20.3247 3.93829 19.9434L7.79552 16.3188C8.16438 15.9722 8.73918 15.9722 9.10803 16.3188L12.9653 19.9435C13.1795 20.1396 13.4647 20.1772 13.7489 20.0569C14.036 19.9354 14.2209 19.6935 14.25 19.4277V4.46616C14.25 3.60837 13.5066 2.87506 12.6988 2.87506H4.39782C3.60984 2.87506 2.8297 3.59367 2.75004 4.50347ZM0.835734 4.39894C0.963818 2.5773 2.49178 0.958389 4.39782 0.958389H12.6988C14.5935 0.958389 16.1667 2.5784 16.1667 4.46616V19.4686C16.1667 19.491 16.1659 19.5135 16.1643 19.5358C16.0162 21.6426 13.3643 22.9209 11.6625 21.3493L11.6564 21.3437L8.45178 18.3323L5.24108 21.3493C3.53393 22.9259 0.833374 21.6337 0.833374 19.3705V4.46616C0.833374 4.44373 0.834161 4.42131 0.835734 4.39894Z"
                  fill="white"
                />
              </svg>
            </div>
            <div class="icon3">
              ...
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M-1 3.68333C-1 1.73155 0.813795 0 3.2798 0H9.77574C11.1323 0 12.5065 0.424458 13.5446 1.29008L13.5572 1.30054L18.2285 5.30406C19.2641 6.1712 19.7901 7.44138 19.642 8.62021V17.9833C19.642 19.9351 17.8283 21.6667 15.3622 21.6667H3.2798C0.813795 21.6667 -1 19.9351 -1 17.9833V3.68333ZM3.2798 2.16667C2.36791 2.16667 1.58333 2.81845 1.58333 3.68333V17.9833C1.58333 18.8482 2.36791 19.5 3.2798 19.5H15.3622C16.2741 19.5 17.0587 18.8482 17.0587 17.9833V8.55833C17.0587 8.51315 17.0621 8.46802 17.0688 8.42319C17.1485 7.89161 16.8978 7.24969 16.4003 6.83492L16.3878 6.82446L11.7176 2.8219C11.1973 2.39059 10.4953 2.16667 9.77574 2.16667H3.2798Z"
                  fill="white"
                />
              </svg>
            </div>
        ...
        <div class="con-input">
          ...
          <div class="submit">
            ...
            >
              <path
                d="M21.2396 0.930801C21.1006 0.815388 20.9316 0.741858 20.7524 0.718778C20.5732 0.695698 20.3912 0.724019 20.2274 0.800441L0.581421 10.0219L0.581421 11.8062L8.83315 15.1069L14.1261 23.25H15.9108L21.5499 1.90313C21.5956 1.72831 21.5907 1.5441 21.5358 1.37195C21.4808 1.19981 21.3781 1.04681 21.2396 0.930801ZM14.8089 21.5481L10.2594 14.5486L17.2603 6.88069L16.1526 5.86932L9.09687 13.597L2.2933 10.8756L19.7984 2.65875L14.8089 21.5481Z"
                fill="white"
              />
            </svg>
          </div>
        ...
        <div class="discuss-box">
          <div class="dis-item">
            ...
            <div class="dis-txt">
              <div class="dis-name">GooodBai @Feb 22, 2022</div>
              <div class="dis-txt-box">
                <p>
                  Love that all your components are made of paper, cardboard and wood. Switch those
                  plastic token containers with wooden ones for and you guys have a 100%
                  eco-friendly shot! external image
                </p>
                <div class="dis-btn-box">
                  <div class="btn-box">
                    ...
                    >
                      <path
                        d="M1 8.42968L1 15.4297M4.5 8.01709V14.5725C4.5 15.6771 5.39543 16.5725 6.5 16.5725H14.3902C15.3301 16.5725 16.1432 15.9181 16.344 14.9999L17.7345 8.64338C17.8709 8.01974 17.396 7.42968 16.7576 7.42968H13C11.8954 7.42968 11 6.53425 11 5.42968V4.04698C11 3.01144 10.5886 2.01832 9.8564 1.28608C9.41613 0.845814 8.68177 0.924715 8.34507 1.44846L4.81764 6.93557C4.61026 7.25817 4.5 7.63358 4.5 8.01709Z"
                        stroke="#111111"
                        stroke-width="2"
                        stroke-linecap="round"
                      />
                  ...
                  <div class="btn-box">
                    ...
                    >
                      <path
                        d="M1 9.14307L1 2.14307M4.5 9.55567V3.00021C4.5 1.89565 5.39543 1.00021 6.5 1.00021H14.3902C15.3301 1.00021 16.1432 1.65465 16.344 2.57282L17.7345 8.92937C17.8709 9.55302 17.396 10.1431 16.7576 10.1431H13C11.8954 10.1431 11 11.0385 11 12.1431V13.5258C11 14.5613 10.5886 15.5544 9.8564 16.2867C9.41613 16.7269 8.68177 16.648 8.34507 16.1243L4.81764 10.6372C4.61026 10.3146 4.5 9.93917 4.5 9.55567Z"
                        stroke="#111111"
                        stroke-width="2"
                        stroke-linecap="round"
                      />
